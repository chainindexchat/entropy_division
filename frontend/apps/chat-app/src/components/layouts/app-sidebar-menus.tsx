...
export function AppSidebarMenus({
  ...
  return (
    <SidebarGroup>
      <SidebarGroupContent>
        <SidebarMenu className="group/about">
          <Tooltip>
            <SidebarMenuItem>
              <SidebarMenuButton
                onClick={toggleAbout}
              ...
              <SidebarMenuAction
                className="group-hover/about:opacity-100 opacity-0 transition-opacity"
                onClick={(e) => {
                  e.stopPropagation();
                  toggleAbout();
                }}
              ...
              {aboutDocs.length === 0 ? (
                ...
                aboutDocs.map((doc) => (
                  <SidebarMenuSubItem
                    ...
                    onClick={() => {
                      setOpenMobile(false);
                      router.push(`/about/${doc.slug}`);
                    }}
                    className="cursor-pointer"
                  >
                    <SidebarMenuSubButton>{doc.title}</SidebarMenuSubButton>
                  </SidebarMenuSubItem>
                ))
              )}
            </SidebarMenuSub>

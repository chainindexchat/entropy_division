...
import { useMidnightWalletState } from "@/hooks/use-midnight-wallet-state";
import {
  connectWallet,
  deployContract,
  joinContract,
  disconnectWallet,
} from "@/lib/midnight-callbacks";
...
export function AppHeader() {
  ...
  const { isConnected: isWalletConnected, isLoading: isWalletLoading } =
          ...
          {!isWalletConnected ? (
            ...
            <DropdownMenu>
              <Tooltip>
                ...
                <TooltipContent align="end" side="bottom">
                  <div className="text-xs">Wallet Connected</div>
                </TooltipContent>
              </Tooltip>
              <DropdownMenuContent align="end" className="min-w-[200px]">
                <DropdownMenuItem onClick={deployContract}>
                  <Rocket className="size-4 mr-2" />
                  Deploy Contract
                </DropdownMenuItem>
                <DropdownMenuItem onClick={joinContract}>

...
import { MidnightUIWrapper } from "@/components/midnight/midnight-ui-wrapper";
import { MidnightDialogsProvider } from "@/components/midnight/midnight-dialogs-provider";
import { getDocs } from "@/lib/docs/get-docs";
...
export default async function ChatLayout({
  ...
  const aboutDocs = getDocs();
  return (
    <SidebarProvider defaultOpen={!isCollapsed}>
      <MidnightDialogsProvider>
        <MidnightUIWrapper />
        <SWRConfigProvider user={session.user}>
          ...
          />
          <AppSidebar user={session.user} aboutDocs={aboutDocs} />

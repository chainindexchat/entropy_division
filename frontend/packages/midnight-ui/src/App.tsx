...
import MidnightWalletProvider from "./providers/MidnightWalletProvider";
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground">Deploy New Contract</h3>
                <div className="space-y-4">
                  <Button
              ...
              {/* Join Contract */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground">Join Existing Contract</h3>
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                ...
                <p className="text-muted-foreground text-sm font-medium">
                  Powered by <span className="text-primary font-semibold hover:underline">MeshJS Team</span>
                </p>
              </a>
            </div>
...
// For standalone build, wrap with providers
function App() {
  return (
